...
class FoodCatalog {
  final List<FoodItem> foods = const [
    ...
    FoodItem(name: 'Spremuta di agrumi', calories: 33, proteins: 0.5, carbs: 8.2, fats: 0),
    FoodItem(name: 'Marmellata', calories: 222, proteins: 0.5, carbs: 58.7, fats: 0),
    FoodItem(name: 'Zucchero', calories: 392, proteins: 0, carbs: 104.5, fats: 0),
    ...
    FoodItem(name: 'Uovo gallina intero (60g)', calories: 128, proteins: 12.4, carbs: 0, fats: 8.7),
    ...
    FoodItem(name: 'Pr. Di Parma/S. Daniele sgrassato', calories: 147.5, proteins: 28.05, carbs: 0, fats: 3.9),
    FoodItem(name: 'Formaggi freschi (valori medi)', calories: 271.33, proteins: 18.78, carbs: 1.05, fats: 21.35),
    FoodItem(name: 'Grana Padano DOP', calories: 398, proteins: 33.0, carbs: 0, fats: 29.0),
    ...
    FoodItem(name: "Olio d'oliva extravergine", calories: 899, proteins: 0, carbs: 0, fats: 99.9),
